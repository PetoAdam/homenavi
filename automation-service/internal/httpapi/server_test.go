		...
		"nodes": []map[string]any{
			{
				...
				"x":    0,
				"y":    0,
				"data": map[string]any{"targets": map[string]any{"type": "device", "ids": []string{"dev-1"}}},
			},
			{
				"id":   "a1",
				...
				"x":    100,
				"y":    0,
				"data": map[string]any{"targets": map[string]any{"type": "device", "ids": []string{"dev-1"}}, "command": "set_state"},
			},
		},
	...
	payload := map[string]any{
		...
		"nodes": []map[string]any{
			...
			},
			{
				...
				"x":    100,
				"y":    0,
				"data": map[string]any{"targets": map[string]any{"type": "device", "ids": []string{"dev-1"}}, "command": ""},
			},
		},
		"edges": []map[string]any{{"from": "t1", "to": "a1"}},
	}
