...
By default, Docker Compose now uses the same release tag as the Helm chart `appVersion` (`v0.4.14`). Override `HN_VERSION` in `.env` only when you intentionally want a different image tag.
