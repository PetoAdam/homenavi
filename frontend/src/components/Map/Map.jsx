  ...
  return (
    <div className="map-page">
      ...
      <div className="map-stage-wrap">
        <div className={`map-stage-content${c.isMapPrepared ? '' : ' map-stage-content-hidden'}`}>
          {c.editEnabled ? (
            <MapEditorTopbar
              canUndo={c.canUndo}
              canRedo={c.canRedo}
          ...
          <div className={`hn-canvas-layout map-layout-shell map-layout${c.editEnabled ? ' edit' : ' view'}`}>
            {c.editEnabled ? (
              <MapDevicePalette
                ersError={c.ersError}
                busy={c.busy}
            ...
            <div className="hn-canvas-center map-canvas-center">
              <div
                className="hn-canvas-surface map-canvas-surface map-canvas"
                ref={c.canvasRef}
              ...
              >
                ...
                <MapSvg
                  ...
                  activeVertexIndex={c.activeVertexIndex}
                  roomLabelFontPx={c.roomLabelFontPx}
                  renderPlacedDevices={c.renderPlacedDevices}
                />

                {c.editEnabled && c.rooms.length === 0 && c.mode !== 'draw' ? (
                  <div className="hn-canvas-empty map-canvas-empty muted">
                ...
                <MapCanvasControls
                  ...
                  decreaseLabelScale={c.decreaseLabelScale}
                  resetLabelScale={c.resetLabelScale}
                  increaseLabelScale={c.increaseLabelScale}
                />
              </div>
            </div>
          </div>
